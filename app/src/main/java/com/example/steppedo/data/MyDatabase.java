package com.example.steppedo.data;
...
public class MyDatabase {
    ...
    public SimpleCursorAdapter getMyListAdapter(){
        ...
        Cursor cursor=db.query("STATISTICS",new String[]{"_id","DATE","DISTANCE","CALORIE"},null,null,null,null,"DATE");
        SimpleCursorAdapter adapter=new SimpleCursorAdapter(context,
                R.layout.view_list_single,
                cursor,
                new String[]{"DATE","DISTANCE","CALORIE"},
                new int[]{R.id.listDate,R.id.listDistance,R.id.listCalorie}, 0);
