...
import com.example.steppedo.data.MyDatabase;
import com.example.steppedo.service.StepListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateValues(){
        ...
        float caloriesc= (float) (STEPS*0.04);
    ...
    public void write(){
        ...
        writeHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                db.writeTo(dateNow,(int)(STEPS*0.762),(float)((int)(STEPS*0.04)));
